...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p1_1)
 ...
 real, dimension(1:829104368) :: p1_1
...
!RF4A Begin Inline
 ...
 i_range___sor_map_20_scal = ((3001 - 0) + 1)
 j_range___sor_map_20_scal = ((3001 - 0) + 1)
 ...
 if (i___sor_map_20_scal == 150 * 20 + 1) then
 p1_1(idx) = p0_s_0(3)
else if ( i___sor_map_20_scal == 0 ) then
 p1_1(idx) = p0_s_0(7)
else if ( j___sor_map_20_scal == 150 * 20 + 1 ) then
 p1_1(idx) = p0_s_0(4)

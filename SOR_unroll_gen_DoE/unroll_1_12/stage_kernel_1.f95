...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p1_1)
 ...
 real, dimension(1:298742768) :: p0_0
 real, dimension(1:298742768) :: rhs_0
 real, dimension(1:298742768) :: p1_1
 integer, dimension(1:9), parameter :: s1=(/ 1803, 3247205, 3247207, 3249006, 3249007, 3249008, &
       3250807, 3250809, 6496211 /)
...
!RF4A Begin Inline
 do s_idx_1 = 1,9
 if (idx+s1(s_idx_1)>=1 .and. idx+s1(s_idx_1)<=298742768) then
 p0_s_0(s_idx_1) = p0_0(idx+s1(s_idx_1))
 else
 p0_s_0(s_idx_1) = p0_0(idx)
 end if
 end do
 i_range___sor_map_20_scal = ((1801 - 0) + 1)
 j_range___sor_map_20_scal = ((1801 - 0) + 1)
 ...
 if (i___sor_map_20_scal == 150 * 12 + 1) then
 p1_1(idx) = p0_s_0(3)
else if ( i___sor_map_20_scal == 0 ) then
 p1_1(idx) = p0_s_0(7)
else if ( j___sor_map_20_scal == 150 * 12 + 1 ) then
 p1_1(idx) = p0_s_0(4)

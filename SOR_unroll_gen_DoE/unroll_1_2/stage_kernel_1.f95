...
subroutine stage_kernel_1(global_id_0,p0_0,rhs_0,p1_1)
 ...
 real, dimension(1:8390768) :: p0_0
 real, dimension(1:8390768) :: rhs_0
 real, dimension(1:8390768) :: p1_1
 integer, dimension(1:9), parameter :: s1=(/ 303, 91205, 91207, 91506, 91507, 91508, 91807, 91809, &
       182711 /)
...
!RF4A Begin Inline
 do s_idx_1 = 1,9
 if (idx+s1(s_idx_1)>=1 .and. idx+s1(s_idx_1)<=8390768) then
 p0_s_0(s_idx_1) = p0_0(idx+s1(s_idx_1))
 else
 p0_s_0(s_idx_1) = p0_0(idx)
 end if
 end do
 i_range___sor_map_20_scal = ((301 - 0) + 1)
 j_range___sor_map_20_scal = ((301 - 0) + 1)
 ...
 if (i___sor_map_20_scal == 150 * 2 + 1) then
 p1_1(idx) = p0_s_0(3)
else if ( i___sor_map_20_scal == 0 ) then
 p1_1(idx) = p0_s_0(7)
else if ( j___sor_map_20_scal == 150 * 2 + 1 ) then
 p1_1(idx) = p0_s_0(4)

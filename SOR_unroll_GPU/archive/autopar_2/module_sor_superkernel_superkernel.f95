...
subroutine sor_superkernel_map_21(p0,rhs,p1)
...
end subroutine sor_superkernel_map_21


subroutine sor_superkernel_map_45(p1,rhs,p2)
...
end subroutine sor_superkernel_map_45


subroutine sor_superkernel_superkernel(p0,rhs,p1,p2,state_ptr)
...
! SUPERKERNEL BODY
  select case(state)
    case (ST_SOR_SUPERKERNEL_MAP_21)
      call sor_superkernel_map_21(p0,rhs,p1)
    case (ST_SOR_SUPERKERNEL_MAP_45)
      call sor_superkernel_map_45(p1,rhs,p2)
  end select

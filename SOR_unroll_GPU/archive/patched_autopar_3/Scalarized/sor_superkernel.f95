...
subroutine sor_superkernel_scal(global_id,p0,rhs,p3,state_ptr)
 integer :: i
 integer :: i_rel
 integer :: j
 integer :: j_range
...
!  use module_sor_superkernel_init
 ...
 integer, parameter :: st_sor_superkernel_map_22=0
 integer, parameter :: st_sor_superkernel_map_46=1
 integer, parameter :: st_sor_superkernel_map_70=2
 state = state_ptr 
!  SUPERKERNEL BODY
 select case(state)
 ...
 k = (k_rel + 0)
call sor_map_22(global_id,p0_i_j_km1,p0_i_jm1_k,p0_im100_j_k,p0_im1_j_k,p0_i_j_k,p0_ip1_j_k, &
 ...
 k_rel = ((global_id - (i_rel * (j_range * k_range))) - (j_rel * k_range))
 k = (k_rel + 0)
call sor_map_46(global_id,p1_i_j_km1,p1_i_jm1_k,p1_im100_j_k,p1_im1_j_k,p1_i_j_k,p1_ip1_j_k, &
 ...
 k_rel = ((global_id - (i_rel * (j_range * k_range))) - (j_rel * k_range))
 k = (k_rel + 0)
call sor_map_70(global_id,p2_i_j_km1,p2_i_jm1_k,p2_im100_j_k,p2_im1_j_k,p2_i_j_k,p2_ip1_j_k, &

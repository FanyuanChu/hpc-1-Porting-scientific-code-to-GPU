...
use singleton_module_sor_map_70, only : sor_map_70_scal
 implicit none
!      BEGIN ex-sub decls sor_map_70_scal
...
!      END ex-sub decls sor_map_70_scal
...
!      BEGIN inlined call to sor_map_70_scal
!   READ
!   WRITTEN
!   READ & WRITTEN
!   globalIdDeclaration
...
!     ! ParallelFortran: Original code
 ...
 reltmp___sor_map_70_scal = 1.0 * (1.0 / 3.0 * (0.5 * p2_s_0(6) + 0.5 * p2_s_0(4) + 0.5 * p2_s_0(8)  &
      + 0.5 * p2_s_0(2) + 0.5 * p2_s_0(9) + 0.5 * p2_s_0(1) - rhs_0) - p2_s_0(5))
 p3_1 = p2_s_0(5) + reltmp___sor_map_70_scal
 end if
!      END inlined call to sor_map_70_scal

module singleton_module_sor_map_70
contains

subroutine sor_map_70_scal(global_id,p2_i_j_km1,p2_i_jm1_k,p2_im100_j_k,p2_im1_j_k,p2_i_j_k,p2_ip1_j_k,p2_ip100_j_k,p2_i_jp1_k,p2_i_j_kp1,rhs_i_j_k,p3_i_j_k)
      implicit none
...
!   READ
 real, intent(in) :: p2_i_j_k
 real, intent(in) :: p2_i_j_km1
 real, intent(in) :: p2_i_j_kp1
 real, intent(in) :: p2_i_jm1_k
 real, intent(in) :: p2_i_jp1_k
 real, intent(in) :: p2_im100_j_k
 real, intent(in) :: p2_im1_j_k
 real, intent(in) :: p2_ip100_j_k
 real, intent(in) :: p2_ip1_j_k
 real, intent(in) :: rhs_i_j_k
!   WRITTEN
 real, intent(out) :: p3_i_j_k
!   READ & WRITTEN
!   globalIdDeclaration
...
!     ! ParallelFortran: Synthesised loop variables
 ...
 i_rel___sor_map_70_scal = (global_id / (j_range___sor_map_70_scal * k_range___sor_map_70_scal))
 i___sor_map_70_scal = (i_rel___sor_map_70_scal + 0)
 j_rel___sor_map_70_scal = ((global_id - (i_rel___sor_map_70_scal * (j_range___sor_map_70_scal * k_range___sor_map_70_scal))) / k_range___sor_map_70_scal)
 j___sor_map_70_scal = (j_rel___sor_map_70_scal + 0)
 k_rel___sor_map_70_scal = ((global_id - (i_rel___sor_map_70_scal * (j_range___sor_map_70_scal * k_range___sor_map_70_scal))) - (j_rel___sor_map_70_scal * k_range___sor_map_70_scal))
 k___sor_map_70_scal = (k_rel___sor_map_70_scal + 0)
!     ! ParallelFortran: Original code
 if (i___sor_map_70_scal == 100 + 1) then
 p3_i_j_k = p2_im100_j_k
else if ( i___sor_map_70_scal == 0 ) then
 p3_i_j_k = p2_ip100_j_k
 ...
 reltmp___sor_map_70_scal = 1.0 * (1.0 / 3.0 * (0.5 * p2_ip1_j_k + 0.5 * p2_im1_j_k + 0.5 * p2_i_jp1_k + 0.5 *        p2_i_jm1_k + 0.5 * p2_i_j_kp1 + 0.5 * p2_i_j_km1 - rhs_i_j_k) - p2_i_j_k)
 p3_i_j_k = p2_i_j_k + reltmp___sor_map_70_scal
 end if
end subroutine sor_map_70_scal
end module singleton_module_sor_map_70

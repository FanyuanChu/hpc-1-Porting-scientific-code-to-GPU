...
subroutine sor_map_22_scal(global_id,p0_i_j_km1,p0_i_jm1_k,p0_im100_j_k,p0_im1_j_k,p0_i_j_k,p0_ip1_j_k,p0_ip100_j_k,p0_i_jp1_k,p0_i_j_kp1,rhs_i_j_k,p1_i_j_k)
      implicit none
...
!     ! ParallelFortran: Synthesised loop variables
 ...
 i_rel___sor_map_22_scal = (global_id / (j_range___sor_map_22_scal * k_range___sor_map_22_scal))
 i___sor_map_22_scal = (i_rel___sor_map_22_scal + 0)
 j_rel___sor_map_22_scal = ((global_id - (i_rel___sor_map_22_scal * (j_range___sor_map_22_scal * k_range___sor_map_22_scal))) / k_range___sor_map_22_scal)
 j___sor_map_22_scal = (j_rel___sor_map_22_scal + 0)
 k_rel___sor_map_22_scal = ((global_id - (i_rel___sor_map_22_scal * (j_range___sor_map_22_scal * k_range___sor_map_22_scal))) - (j_rel___sor_map_22_scal * k_range___sor_map_22_scal))
...
!     ! ParallelFortran: Original code
 ...
 reltmp___sor_map_22_scal = 1.0 * (1.0 / 3.0 * (0.5 * p0_ip1_j_k + 0.5 * p0_im1_j_k + 0.5 * p0_i_jp1_k + 0.5 *        p0_i_jm1_k + 0.5 * p0_i_j_kp1 + 0.5 * p0_i_j_km1 - rhs_i_j_k) - p0_i_j_k)
 p1_i_j_k = p0_i_j_k + reltmp___sor_map_22_scal
 end if
end subroutine sor_map_22_scal

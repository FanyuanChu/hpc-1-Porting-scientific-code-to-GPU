...
subroutine sor_map_22(global_id,p0,rhs,p1)
...
subroutine sor_map_46(global_id,p1,rhs,p2)
...
subroutine sor_map_70(global_id,p2,rhs,p3)
...
subroutine sor_superkernel(global_id, p0, rhs, p3, state_ptr)
...
! use module_sor_superkernel_init
  ...
  integer :: state
  integer :: state_ptr
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_22 = 0 !  sor_map_22
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_46 = 1 !  sor_map_46
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_70 = 2 !  sor_map_70
  state = state_ptr ! state 
! SUPERKERNEL BODY
  select case(state)
    case (ST_SOR_SUPERKERNEL_MAP_22)
      call sor_map_22(global_id,p0,rhs,p1)
    case (ST_SOR_SUPERKERNEL_MAP_46)
      call sor_map_46(global_id,p1,rhs,p2)
    case (ST_SOR_SUPERKERNEL_MAP_70)
      call sor_map_70(global_id,p2,rhs,p3)
  end select

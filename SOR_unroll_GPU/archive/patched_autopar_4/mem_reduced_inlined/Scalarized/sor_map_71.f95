...
subroutine sor_map_71_scal(global_id,p2_i_j_km1,p2_i_jm1_k,p2_im100_j_k,p2_im1_j_k,p2_i_j_k,p2_ip1_j_k,p2_ip100_j_k,p2_i_jp1_k,p2_i_j_kp1,rhs_i_j_k,p3_i_j_k)
      implicit none
...
!     ! ParallelFortran: Synthesised loop variables
 ...
 i_rel___sor_map_71_scal = (global_id / (j_range___sor_map_71_scal * k_range___sor_map_71_scal))
 i___sor_map_71_scal = (i_rel___sor_map_71_scal + 0)
 j_rel___sor_map_71_scal = ((global_id - (i_rel___sor_map_71_scal * (j_range___sor_map_71_scal * k_range___sor_map_71_scal))) / k_range___sor_map_71_scal)
 j___sor_map_71_scal = (j_rel___sor_map_71_scal + 0)
 k_rel___sor_map_71_scal = ((global_id - (i_rel___sor_map_71_scal * (j_range___sor_map_71_scal * k_range___sor_map_71_scal))) - (j_rel___sor_map_71_scal * k_range___sor_map_71_scal))
...
!     ! ParallelFortran: Original code
 ...
 reltmp___sor_map_71_scal = 1.0 * (1.0 / 3.0 * (0.5 * p2_ip1_j_k + 0.5 * p2_im1_j_k + 0.5 * p2_i_jp1_k + 0.5 *        p2_i_jm1_k + 0.5 * p2_i_j_kp1 + 0.5 * p2_i_j_km1 - rhs_i_j_k) - p2_i_j_k)
 p3_i_j_k = p2_i_j_k + reltmp___sor_map_71_scal
 end if
end subroutine sor_map_71_scal

...
use singleton_module_sor_map_47, only : sor_map_47_scal
 implicit none
!      BEGIN ex-sub decls sor_map_47_scal
...
!      END ex-sub decls sor_map_47_scal
...
!      BEGIN inlined call to sor_map_47_scal
!   READ
!   WRITTEN
!   READ & WRITTEN
!   globalIdDeclaration
...
!     ! ParallelFortran: Original code
 ...
 reltmp___sor_map_47_scal = 1.0 * (1.0 / 3.0 * (0.5 * p1_s_0(6) + 0.5 * p1_s_0(4) + 0.5 * p1_s_0(8)  &
      + 0.5 * p1_s_0(2) + 0.5 * p1_s_0(9) + 0.5 * p1_s_0(1) - rhs_0) - p1_s_0(5))
 p2_1 = p1_s_0(5) + reltmp___sor_map_47_scal
 end if
!      END inlined call to sor_map_47_scal

...
subroutine sor_superkernel_map_22(p0,rhs,p1)
...
end subroutine sor_superkernel_map_22


subroutine sor_superkernel_map_46(p1,rhs,p2)
...
end subroutine sor_superkernel_map_46


subroutine sor_superkernel_map_70(p2,rhs,p3)
...
end subroutine sor_superkernel_map_70


subroutine sor_superkernel_superkernel(p0,rhs,p1,p2,p3,state_ptr)
! use module_sor_superkernel_superkernel_init
  ...
  integer :: state
  integer :: state_ptr
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_22 = 0 !  sor_superkernel_map_22
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_46 = 1 !  sor_superkernel_map_46
integer, parameter :: ST_SOR_SUPERKERNEL_MAP_70 = 2 !  sor_superkernel_map_70
  state = state_ptr ! state 
! SUPERKERNEL BODY
  select case(state)
    case (ST_SOR_SUPERKERNEL_MAP_22)
      call sor_superkernel_map_22(p0,rhs,p1)
    case (ST_SOR_SUPERKERNEL_MAP_46)
      call sor_superkernel_map_46(p1,rhs,p2)
    case (ST_SOR_SUPERKERNEL_MAP_70)
      call sor_superkernel_map_70(p2,rhs,p3)
  end select
